...
for antena_type in antenas:
    for antena_pair in combinations(antenas[antena_type], 2):
        ...
        i = 0
        while True:
            new_point_1 = (antena_pair[0][0] - i * distance_vector[0],
                           antena_pair[0][1] - i * distance_vector[1])
            if new_point_1[0] <= row_index and new_point_1[0] >= 0 and new_point_1[1] <= col_length and new_point_1[1] >= 0:
                if new_point_1 not in antinodes:
        ...
        i = 0
        while True:
            new_point_2 = (antena_pair[1][0] + i * distance_vector[0],
                           antena_pair[1][1] + i * distance_vector[1])
            if new_point_2[0] <= row_index and new_point_2[0] >= 0 and new_point_2[1] <= col_length and new_point_2[1] >= 0:
                if new_point_2 not in antinodes:
